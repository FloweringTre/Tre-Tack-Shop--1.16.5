    ...
    // BUTTERFLY - MORPHO -- Uncraftable Blue Morpho Tack
        HALTER_MORPHO = ITEMS.register("halter_morpho",
                () -> new HalterItem("halter_morpho", (new Item.Properties())
                        .group(TackShopCreativeModTab.TREAWARD_TAB).maxStackSize(16)));
        ...
        ADVENTURE_SADDLE_MORPHO = ITEMS.register("adventure_saddle_morpho",
                () -> new AdventureSaddleItem("adventure_saddle_morpho", (new Item.Properties())
                        .group(TackShopCreativeModTab.TREAWARD_TAB).maxStackSize(1)));
        ...
        ADVENTURE_LEG_WRAPS_MORPHO = ITEMS.register("adventure_leg_wraps_morpho",
                () -> new AdventureLegWraps("adventure_leg_wraps_morpho", (new Item.Properties())
                        .group(TackShopCreativeModTab.TREAWARD_TAB).maxStackSize(64)));
        ...
        FLAG_MORPHO = ITEMS.register("flag_morpho", () ->
                new Item((new Item.Properties().group(TackShopCreativeModTab.TREAWARD_TAB))));
    ...
    // Dye Color number items
        ...
        for(int var2 = 0; var2 < var3; ++var2) {
            DyeColor color = var0[var2];
             RIBBON_THREE_TAILS.add(ITEMS.register("ribbon_three_tails_" + color.getString(), () ->
                     new Item(new Item.Properties().group(TackShopCreativeModTab.TREAWARD_TAB))
             ));
             RIBBON_TWO_TAILS.add(ITEMS.register("ribbon_two_tails_" + color.getString(), () ->
                     new Item(new Item.Properties().group(TackShopCreativeModTab.TREAWARD_TAB))
             ));
             RIBBON_ONE_TAIL.add(ITEMS.register("ribbon_one_tail_" + color.getString(), () ->
                     new Item(new Item.Properties().group(TackShopCreativeModTab.TREAWARD_TAB))
             ));
             ROSETTE.add(ITEMS.register("rosette_" + color.getString(), () ->
                     new Item(new Item.Properties().group(TackShopCreativeModTab.TREAWARD_TAB))
             ));
         }
